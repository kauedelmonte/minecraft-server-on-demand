...
resource "aws_iam_role" "ecs_instance" {
  name               = "${var.namespace}-${var.environment}-ecs-instance-role"
  assume_role_policy = data.aws_iam_policy_document.ecs_instance_assume.json
}

resource "aws_iam_instance_profile" "ecs_instance" {
  name = "${var.namespace}-${var.environment}-ecs-instance-profile"
...
resource "aws_iam_role" "ecs_task_execution" {
  name               = "${var.namespace}-${var.environment}-ecs-task-exec-role"
